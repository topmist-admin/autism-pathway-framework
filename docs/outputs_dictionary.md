...
9. [Interpretation Guardrails](#interpretation-guardrails)
10. [What NOT to Infer](#what-not-to-infer)
...
| validation | Validation metrics (if ground truth available) |
...
4. **Validation**: ARI score if ground truth available
5. **Disclaimer**: Research-use notice
...
| Bootstrap stability | >0.8 | Stable cluster assignments |
...
*Last updated: 2024-01-27 | Autism Pathway Framework v0.1*
