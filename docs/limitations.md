...
This document explicitly acknowledges the limitations of the pathway- and network-based framework. Understanding these constraints is essential for appropriate interpretation and use.
...
- Predict who will develop autism
...
- **Update lag**: Databases don't capture recent discoveries
...
- **Gene-environment interactions**: G×E effects
- **Microbiome**: Gut-brain connections
- **Somatic mosaicism**: Post-zygotic mutations

### 4. Network Limitations

Gene-gene networks are:
- **Incomplete**: Many interactions unknown
- **Context-dependent**: Interactions vary by cell type and condition
- **Biased**: Toward well-studied genes and proteins
- **Approximate**: Confidence scores are imperfect
...
With thousands of pathways and genes:
...
### 1. Biological Plausibility ≠ Truth
...
- True biological effects may not replicate due to:
  ...
  - Insufficient power
- Failed replication doesn't prove null (may be underpowered)
- Successful replication doesn't prove causation
...
- Reinforce medical model of autism
- Miss protective factors
- Ignore autistic perspectives
...
| Cannot Do | Why |
|-----------|-----|
| Diagnose autism | Not validated for clinical use |
...
✓ Prioritizing pathways for experimental follow-up
...
| Overfitting | Regularization; cross-validation; replication |
...
Acknowledging limitations is not weakness—it is scientific integrity. This framework offers a principled approach to studying autism genetics, but its outputs are starting points for further research, not conclusions.
